...
},{"../solver/block":28,"./common.js":26}],28:[function(require,module,exports){
class block {
...
class solver {
    ...
    solvePuzzel() {        
        ...
        var start = new Date();
        this.solve(stop, (lastStateBlock)=> {
            var end = new Date();
...
},{"../helpers/common":26,"../helpers/helper":27,"./block":28,"./board":29,"collections/deque":6,"collections/sorted-map":21,"collections/sorted-set":22}],31:[function(require,module,exports){
...
// console.log(ar);
// console.log(br);
},{"../helpers/helper":27,"../solver/board":29,"./solver":30,"collections/sorted-set":22}]},{},[31]);
